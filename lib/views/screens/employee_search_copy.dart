    ...
    return SafeArea(
      ...
      body: Column(
        ...
        children: [
          ...
          Provider.of<EmployeesSearchProvider>(context, listen: false)
                      .empList
                      .length !=
                  0
              ? Text(
              ...
              : Text(''),
          Provider.of<EmployeesSearchProvider>(context,listen:true).empList.length == 0 &&
                      employeeSearchController.text.length != 0
                  ? Expanded(child: Text("No employee found"))
                  : employeeSearchController.text.length >= 3
                      ? FutureBuilder(
                          future: Provider.of<EmployeesSearchProvider>(context,listen:false).setEmpList(
                              search: employeeSearchController.text),
                          builder: (context, snapshot) {
                            if (snapshot.connectionState ==
                              ...
                              return Expanded(
                                child: Scrollbar(
                                  child: ListView(
                                    children: Provider.of<EmployeesSearchProvider>(context,listen:false).empList
                                        .map((item) => Container(
